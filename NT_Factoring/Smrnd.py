...
def action(k, primes, UPPER_BOUND):
    prod = 1
    s = []
    while (k % (prod*2) == 0):
           s.append("2")
...
# This program will find all prime factors below UPPER_BOUND. Some larger factors may be found also.
UPPER_BOUND = 20000
primes = generate_primes(UPPER_BOUND)
x = int(input("Please enter an integer..\n"))
action(x, primes, UPPER_BOUND)
