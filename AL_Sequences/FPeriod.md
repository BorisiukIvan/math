...
Example: if $f(x,a) := x^2-a $, then for $a = 1$ the attractive cycle is $\{0,1\}$ because no matter what $n\in[0; 1]$ we take, the sequence $s$ eventually will approach infinitely closely to $(0, 1, 0, 1, ...)$. Also, for any $a \in [1; ~1
